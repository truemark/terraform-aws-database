locals {
  tags = merge(var.tags,
    {
      "automation:component-id"     = "rds-aurora-mysql-serverless-v2",
      "automation:component-url"    = "https://registry.terraform.io/modules/truemark/database/aws/latest/submodules/mysql-aurora-serverless-v2",
